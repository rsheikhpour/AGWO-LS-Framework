%% =========================================================================
%  AGWO_LS_DT: Adaptive Grey Wolf Optimizer with Local Search (AGWO-LS)
%               for Decision Tree Hyperparameter Optimization
% =========================================================================
%
%  Reference:
...
%
%  Usage:
%    [params, fitness, curve] = AGWO_LS_DT(X_train, y_train, 100, 30);
%    max_depth  = round(params(1));
%    min_split  = round(params(2));
%
% =========================================================================

function [best_params, best_fitness, conv_curve] = AGWO_LS_DT(...
...
fprintf('AGWO-LS DT | max_depth[%d,%d], min_split[%d,%d]\n',...
    lb(1),ub(1), lb(2),ub(2));
...
for i = 1:n_wolves
    fitness(i) = dtObjective(X(i,:), X_train, y_train);
end
...
fprintf('\n--- AGWO-LS DT Optimization Started ---\n');
...
for t = 1:max_iter
    ...
    for ls_iter = 1:ls_max_iter
        ...
        for j = 1:dim
            ...
            f_cand = dtObjective(X_cand, X_train, y_train);
    ...
    fprintf('Iter %3d/%d | Best CV error = %.4f | max_depth=%d, min_split=%d\n',...
        t, max_iter, f_alpha, round(X_alpha(1)), round(X_alpha(2)));
end
...
end % function AGWO_LS_DT


%% =========================================================================
%  Local Function: dtObjective
% =========================================================================
function cv_error = dtObjective(params, X_train, y_train)
